...
('1', 'alice@example.com', 3, 'password123');
...
('aiz@gmail.com', 'Aiz', 12345555, '1824817H', 1),
('khai@gmail.com', 'Khai', 12345678, '1824818H', 1),
('alice@example.com', 'Alice Wonderland', 1234567890, 'S123456', 1);
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `Courses_dates_id_fk` FOREIGN KEY (`date_id`) REFERENCES `date` (`date_id`),
